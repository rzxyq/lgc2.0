...
def basic(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = '''Thanks for completing the New Students survey! You may wish to familiarize yourself with the schedule here: http://www.letsgetcoffeecornell.com/timeline/.  Please be on the lookout for an email once an upperclassman has selected you. If you don't get one by Sept. 20, please let us know.'''
