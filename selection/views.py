...
def selection(request):
    ...
    message2 = 'Congratulations! You were just selected by an upperclassman participating in Let\'s Get Coffee.\n\n' + upper.name + ' (' + upper.netid + ') will serve as your upperclassman connection in the Spring 2017 Round of Let\'s Get Coffee. It is his or her responsiblity to email you to arrange a meeting at a public place on campus by the end of Feb. 14.\n\nIf you do not hear from your upperclassman by Feb. 14, please be patient and give them a little more time. If you do not hear from them by Wednesday, please send them an email introducing yourself as their new student connection via Let\'s Get Coffee.\n\nIf you do not hear back from them or have any other questions or concerns, please send us an email at letsgetcoffeecornell@gmail.com. We hope you have an awesome meeting with your upperclassman that becomes the start of a great friendship.' + '\n\nBest, \nThe Let\'s Get Coffee Steering Committee\n'
